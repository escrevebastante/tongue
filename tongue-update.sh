...
#Pike
wget -c -N -r --no-parent -A html,png,css,jpg,jpeg,svg -t 1 https://docs.openstack.org/glance/pike/install/ --directory-prefix $DOCUMENTPATH
wget -c -N -r --no-parent -A html,png,css,jpg,jpeg,svg -t 1 https://docs.openstack.org/ironic/pike/install/ --directory-prefix $DOCUMENTPATH
wget -c -N -r --no-parent -A html,png,css,jpg,jpeg,svg -t 1 https://docs.openstack.org/cinder/pike/install/ --directory-prefix $DOCUMENTPATH
wget -c -N -r --no-parent -A html,png,css,jpg,jpeg,svg -t 1 https://docs.openstack.org/nova/pike/install/ --directory-prefix $DOCUMENTPATH
wget -c -N -r --no-parent -A html,png,css,jpg,jpeg,svg -t 1 https://docs.openstack.org/horizon/pike/install/ --directory-prefix $DOCUMENTPATH
wget -c -N -r --no-parent -A html,png,css,jpg,jpeg,svg -t 1 https://docs.openstack.org/keystone/pike/install/ --directory-prefix $DOCUMENTPATH
wget -c -N -r --no-parent -A html,png,css,jpg,jpeg,svg -t 1 https://docs.openstack.org/neutron/pike/install/ --directory-prefix $DOCUMENTPATH
wget -c -N -r --no-parent -A html,png,css,jpg,jpeg,svg -t 1 https://docs.openstack.org/swift/pike/install/ --directory-prefix $DOCUMENTPATH
wget -c -N -r --no-parent -A html,png,css,jpg,jpeg,svg -t 1 https://docs.openstack.org/heat/pike/install/ --directory-prefix $DOCUMENTPATH
wget -c -N -r --no-parent -A html,png,css,jpg,jpeg,svg -t 1 https://docs.openstack.org/glance/pike/admin/ --directory-prefix $DOCUMENTPATH
wget -c -N -r --no-parent -A html,png,css,jpg,jpeg,svg -t 1 https://docs.openstack.org/ironic/pike/admin/ --directory-prefix $DOCUMENTPATH
wget -c -N -r --no-parent -A html,png,css,jpg,jpeg,svg -t 1 https://docs.openstack.org/cinder/pike/admin/ --directory-prefix $DOCUMENTPATH
wget -c -N -r --no-parent -A html,png,css,jpg,jpeg,svg -t 1 https://docs.openstack.org/nova/pike/admin/ --directory-prefix $DOCUMENTPATH
wget -c -N -r --no-parent -A html,png,css,jpg,jpeg,svg -t 1 https://docs.openstack.org/horizon/pike/admin/ --directory-prefix $DOCUMENTPATH
wget -c -N -r --no-parent -A html,png,css,jpg,jpeg,svg -t 1 https://docs.openstack.org/keystone/pike/admin/ --directory-prefix $DOCUMENTPATH
wget -c -N -r --no-parent -A html,png,css,jpg,jpeg,svg -t 1 https://docs.openstack.org/neutron/pike/admin/ --directory-prefix $DOCUMENTPATH
wget -c -N -r --no-parent -A html,png,css,jpg,jpeg,svg -t 1 https://docs.openstack.org/swift/pike/admin/ --directory-prefix $DOCUMENTPATH
wget -c -N -r --no-parent -A html,png,css,jpg,jpeg,svg -t 1 https://docs.openstack.org/heat/pike/admin/ --directory-prefix $DOCUMENTPATH
wget -c -N -r --no-parent -A html,png,css,jpg,jpeg,svg -t 1 https://docs.openstack.org/glance/pike/user/ --directory-prefix $DOCUMENTPATH
wget -c -N -r --no-parent -A html,png,css,jpg,jpeg,svg -t 1 https://docs.openstack.org/ironic/pike/user/ --directory-prefix $DOCUMENTPATH
wget -c -N -r --no-parent -A html,png,css,jpg,jpeg,svg -t 1 https://docs.openstack.org/cinder/pike/user/ --directory-prefix $DOCUMENTPATH
wget -c -N -r --no-parent -A html,png,css,jpg,jpeg,svg -t 1 https://docs.openstack.org/nova/pike/user/ --directory-prefix $DOCUMENTPATH
wget -c -N -r --no-parent -A html,png,css,jpg,jpeg,svg -t 1 https://docs.openstack.org/horizon/pike/user/ --directory-prefix $DOCUMENTPATH
wget -c -N -r --no-parent -A html,png,css,jpg,jpeg,svg -t 1 https://docs.openstack.org/keystone/pike/user/ --directory-prefix $DOCUMENTPATH
wget -c -N -r --no-parent -A html,png,css,jpg,jpeg,svg -t 1 https://docs.openstack.org/neutron/pike/user/ --directory-prefix $DOCUMENTPATH
wget -c -N -r --no-parent -A html,png,css,jpg,jpeg,svg -t 1 https://docs.openstack.org/swift/pike/user/ --directory-prefix $DOCUMENTPATH
wget -c -N -r --no-parent -A html,png,css,jpg,jpeg,svg -t 1 https://docs.openstack.org/heat/pike/user/ --directory-prefix $DOCUMENTPATH
wget -c -N -r --no-parent -A html,png,css,jpg,jpeg,svg -t 1 https://docs.openstack.org/glance/pike/configuration/ --directory-prefix $DOCUMENTPATH
wget -c -N -r --no-parent -A html,png,css,jpg,jpeg,svg -t 1 https://docs.openstack.org/ironic/pike/configuration/ --directory-prefix $DOCUMENTPATH
wget -c -N -r --no-parent -A html,png,css,jpg,jpeg,svg -t 1 https://docs.openstack.org/cinder/pike/configuration/ --directory-prefix $DOCUMENTPATH
wget -c -N -r --no-parent -A html,png,css,jpg,jpeg,svg -t 1 https://docs.openstack.org/nova/pike/configuration/ --directory-prefix $DOCUMENTPATH
wget -c -N -r --no-parent -A html,png,css,jpg,jpeg,svg -t 1 https://docs.openstack.org/horizon/pike/configuration/ --directory-prefix $DOCUMENTPATH
wget -c -N -r --no-parent -A html,png,css,jpg,jpeg,svg -t 1 https://docs.openstack.org/keystone/pike/configuration/ --directory-prefix $DOCUMENTPATH
wget -c -N -r --no-parent -A html,png,css,jpg,jpeg,svg -t 1 https://docs.openstack.org/neutron/pike/configuration/ --directory-prefix $DOCUMENTPATH
wget -c -N -r --no-parent -A html,png,css,jpg,jpeg,svg -t 1 https://docs.openstack.org/swift/pike/configuration/ --directory-prefix $DOCUMENTPATH
wget -c -N -r --no-parent -A html,png,css,jpg,jpeg,svg -t 1 https://docs.openstack.org/heat/pike/configuration/ --directory-prefix $DOCUMENTPATH
#Queens
